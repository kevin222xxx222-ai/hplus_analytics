...
export default async function ImportsPage() {
  ...
  return <><PageHeader eyebrow="CTI IMPORT" title="CTI女子別レポート取込" description="XLSXを検証し、プレビューと未紐付け確認を経てから日次実績へ確定します。" />
    <div className="mb-4 flex justify-end gap-2"><Link href="/imports/heaven" className="secondary-button">Heaven CSV取込</Link><Link href="/imports/cti/bulk" className="secondary-button"><FolderSearch className="size-4" />ローカルフォルダ一括取込</Link></div>
