...
const nav = [
  ...
  { href: "/analytics/cast", label: "Cast Analytics", icon: UsersRound },
  { href: "/analytics/store", label: "Store Analytics", icon: Building2 },
  ...
  { href: "/analytics/time", label: "Time Analytics", icon: BarChart3 },
