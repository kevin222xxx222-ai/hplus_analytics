...
describe("J1 cleanup classification", () => {
  ...
  it("protects retired markers from membership creation", () => expect(classifyJ1({ status: "ACTIVE", merged: false, memberships: 0, aliases: 0, listings: 1, townCurrent: true, hasEndedOn: false, marker: true }).classification).toBe("RETIRED_MARKER_CURRENT_EVIDENCE_CONFLICT"));
});
