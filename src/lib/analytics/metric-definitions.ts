...
export const METRIC_DEFINITIONS: Record<string, MetricDefinition> = {
  ...
  townPv: d("townPv", "TownキャストページPV", "Town", "Townキャストページの閲覧数です。", "キャストページの露出規模を確認します。", "未掲載・未取得は0ではなく—です。予約経路とは結び付きません。", "対象期間PV合計", "PV"),
  townUu: d("townUu", "TownキャストページUU", "Town", "Townキャストページのユニーク閲覧数です。", "閲覧した利用者規模を確認します。", "CTI成約と顧客単位では対応しません。", "対象期間UU", "UU"),
  ...
  heavenMyGirlAdds: d("heavenMyGirlAdds", "Heaven マイガール増加数", "Heaven", "HeavenのMY_GIRL Snapshotから安全に算出した期間内の増加数です。", "アクセス後の登録増加を確認します。", "Snapshotの欠測・リセットは0補完せず、暫定または比較不能として扱います。", "有効なSnapshot差分の合計", "件"),
  heavenFavoriteTalks: d("heavenFavoriteTalks", "Heaven オキニトーク送信数", "Heaven", "Heavenのオキニトーク送信数の日次イベント合計です。", "接触活動量を確認します。", "成約への因果関係は断定しません。", "DAILY_EVENTの期間合計", "件"),
  heavenMyGirlAddsPer100Access: d("heavenMyGirlAddsPer100Access", "マイガール増加／100アクセス", "Heaven", "アクセス100件あたりのマイガール増加数です。", "アクセスから登録への参考転換を確認します。", "分母0・欠測時は算出しません。", "マイガール増加 ÷ Heavenアクセス × 100", "件"),
  heavenMyGirlAddsPer100TownUu: d("heavenMyGirlAddsPer100TownUu", "マイガール増加／100 Town UU", "Heaven", "Town UU 100人あたりのマイガール増加数です。", "媒体横断の参考値を確認します。", "媒体間の顧客同一性や経路は断定しません。", "マイガール増加 ÷ Town UU × 100", "件"),
  heavenFavoriteTalksPerAttendanceDay: d("heavenFavoriteTalksPerAttendanceDay", "オキニトーク／出勤日", "Heaven", "出勤日1日あたりのオキニトーク送信数です。", "活動量の参考効率を確認します。", "出勤日との因果関係は断定しません。", "オキニトーク ÷ 出勤日数", "件/日"),
  heavenFavoriteTalksPer100Access: d("heavenFavoriteTalksPer100Access", "オキニトーク／100アクセス", "Heaven", "アクセス100件あたりのオキニトーク送信数です。", "接触活動の参考効率を確認します。", "分母0・欠測時は算出しません。", "オキニトーク ÷ Heavenアクセス × 100", "件"),
