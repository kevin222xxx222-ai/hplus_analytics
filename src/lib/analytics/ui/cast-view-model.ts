...
export const castMetricLabels: Record<string, string> = { sales: "売上", castReward: "女子報酬", attendancePeople: "出勤", reservations: "予約", services: "接客", regularNominations: "本指名", diaryPosts: "写メ日記投稿数", salesPerHour: "売上／時間", rewardPerHour: "女子報酬／時間", townPv: "TownキャストページPV", townUu: "TownキャストページUU", heavenAccess: "Heaven女の子ページアクセス" };
